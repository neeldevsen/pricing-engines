...
PYBIND11_MODULE(heston_qe, m)
{
    m.doc() = "Heston Quadratic Exponential pricing engine";

    m.def("call",
        [](double spot, double strike, double rate, double maturity, double variance, double kappa, double theta, double xi, double rho, int M, int N, double threshold, double gamma1, double gamma2)
        {
            OptionDataHeston option {spot, strike, rate, maturity, variance, kappa, theta, xi, rho};
            return hestonQECall(option, M, N, threshold, gamma1, gamma2);
        },
        py::arg("spot"),
        py::arg("strike"),
        py::arg("rate"),
    ...
    m.def("put",
        ...
        {
            OptionDataHeston option {spot, strike, rate, maturity, variance, kappa, theta, xi, rho};
            return hestonQEPut(option, M, N, threshold, gamma1, gamma2);
        },
        py::arg("spot"),
        py::arg("strike"),
        py::arg("rate"),
